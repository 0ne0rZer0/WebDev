let gifs = [
  "res/orignals/strangerThings.gif",
  "res/orignals/moneyheist.gif",
  "res/orignals/peakyblinders.gif",
  "res/orignals/sacredGames.gif",
  "res/orignals/bojack.gif",
  "res/orignals/you.gif",
];
gifs = [...gifs, ...gifs];
